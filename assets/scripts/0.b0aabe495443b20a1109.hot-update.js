...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var osm = new L.TileLayer('http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', { zIndex: 100 });
	...
	*/
	...
	// map.addLayer(osm);
	// osm.addTo(map).setZIndex(0);
	map.addLayer(yndx);
	map.addLayer(osm);
	
	// osm.autoZIndex
	// const layers(yndx, osm).addTo(map);
	...
	map.addControl(new L.Control.Layers({ "Yandex": yndx, 'OSM': osm }
	// {"Traffic":ytraffic}
	));
...
//# sourceMappingURL=0.b0aabe495443b20a1109.hot-update.js.map